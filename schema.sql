...
CREATE TABLE IF NOT EXISTS reservations (
  ...
  approval_status ENUM('pending', 'approved', 'rejected', 'need_revision', 'revision_overdue') NOT NULL DEFAULT 'pending' COMMENT '預約審核狀態',
  revision_deadline DATETIME NULL COMMENT '補件期限',
...
-- ALTER TABLE reservations ADD COLUMN organization_name VARCHAR(100) NULL COMMENT '���W�� / �D�����';
-- ALTER TABLE reservations ADD COLUMN activity_name VARCHAR(100) NULL COMMENT '���ʦW��';
-- ALTER TABLE reservations ADD COLUMN participant_count VARCHAR(20) NULL COMMENT '���ʹ�H�H��';
-- ALTER TABLE reservations ADD COLUMN staff_count INT NULL COMMENT '�u�@�H���H��';
-- ALTER TABLE reservations ADD COLUMN club_president VARCHAR(50) NULL COMMENT '�� / �|��';

- -   A L T E R   T A B L E   r e s e r v a t i o n s   A D D   C O L U M N   a c t i v i t y _ c o o r d i n a t o r   V A R C H A R ( 5 0 )   N U L L   C O M M E N T   ' ;m�R�����N' ; 
 - -   A L T E R   T A B L E   r e s e r v a t i o n s   A D D   C O L U M N   c o o r d i n a t o r _ d e p a r t m e n t   V A R C H A R ( 5 0 )   N U L L   C O M M E N T   ' �|}' ; 
 - -   A L T E R   T A B L E   r e s e r v a t i o n s   A D D   C O L U M N   c o o r d i n a t o r _ p h o n e   V A R C H A R ( 5 0 )   N U L L   C O M M E N T   ' o�a}��q�' ; 
 - -   A L T E R   T A B L E   r e s e r v a t i o n s   A D D   C O L U M N   c o o r d i n a t o r _ o t h e r _ c o n t a c t   V A R C H A R ( 2 5 5 )   N U L L   C O M M E N T   ' vQ�No�a}�e_' ;  
